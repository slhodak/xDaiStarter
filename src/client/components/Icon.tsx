  ...
  email: () => {
    return (
      <svg className='icon' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M22 2L11 13" stroke="#3EC6C1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M22 2L15 22L11 13L2 9L22 2Z" stroke="#3EC6C1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    )
  },
  twitter: () => {
  ...
  lock: () => {
    return (
      <svg className='lock' width="34" height="38" viewBox="0 0 34 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M28.6667 17H5.33333C3.49238 17 2 18.5467 2 20.4545V32.5455C2 34.4533 3.49238 36 5.33333 36H28.6667C30.5076 36 32 34.4533 32 32.5455V20.4545C32 18.5467 30.5076 17 28.6667 17Z" stroke="#3EC6C1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M9 17V10.3333C9 8.1232 9.89553 6.00358 11.4896 4.44078C13.0837 2.87797 15.2457 2 17.5 2C19.7543 2 21.9163 2.87797 23.5104 4.44078C25.1045 6.00358 26 8.1232 26 10.3333V17" stroke="#3EC6C1" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    )
  }
};
